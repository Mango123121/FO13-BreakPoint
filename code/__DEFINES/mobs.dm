...
//Respawn timer
#define RESPAWN_TIMER 6000 // (10 minutes) || in deciseconds, the time to wait before allowing respawn. 15 minutes = 15 * 60 (seconds in minute) * 15 (seconds to deciseconds)
